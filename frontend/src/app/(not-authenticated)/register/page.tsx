      ...
      <div className="lg:p-8">
        <div className="mx-auto flex w-full flex-col justify-center space-y-6 sm:w-[350px]">
          ...
          <div className="flex w-full flex-row justify-between">
            <CardDescription className="hover:underline cursor-pointer">Have an account? Login</CardDescription>
            <CardDescription className="hover:underline cursor-pointer">Forgot password?</CardDescription>
          </div>
        </div>
      </div>
    </div>
