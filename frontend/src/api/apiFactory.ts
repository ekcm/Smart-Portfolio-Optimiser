...
export const ASSET_PRICE_API_PATH = process.env.NEXT_PUBLIC_ASSET_PRICE_API_PATH || "/assetprice";
export const ORDER_API_PATH = process.env.NEXT_PUBLIC_ORDER_API_PATH || "/order";
export const PORTFOLIO_API_PATH = process.env.NEXT_PUBLIC_PORTFOLIO_API_PATH || "/portfolio";
...
// export const AUTH_API_PATH = process.env.NEXT_PUBLIC_AUTH_API_PATH || "/api/v1/auth";