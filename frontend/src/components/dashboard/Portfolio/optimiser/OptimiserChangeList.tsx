...
export default function OptimiserChangeList({ data, optimisedData, optimisedFlag } : OptimiserChangeListProps) {
    ...
    return (
        <div className="flex flex-col gap-4">
            <h1 className="text-2xl font-medium">Changes</h1>
            <div className="grid grid-cols-2 gap-4">
                <div className="flex flex-col gap-2">
                    <h2 className="text-lg font-medium">Current Portfolio Holdings</h2>
                    <OldOrdersCard data={data.portfolioHoldings} />
                </div>
                <div className="flex flex-col gap-2">
                    <h2 className="text-lg font-medium">Proposed Portfolio Holdings</h2>
